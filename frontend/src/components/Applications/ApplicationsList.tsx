...
import { Calendar, Building, CheckCircle2, RefreshCw } from 'lucide-react';
...
export const ApplicationsList: React.FC = () => {
  ...
  return (
    <div className={`${styles.applicationsContainer} glass-dark`}>
      <h1 className={styles.appsTitle}>My Applications</h1>
      
      <div className={styles.appsStats}>
        <div className={`${styles.statItem} glass`}>
          <span className={styles.statLabel}>Applied</span>
          <span className={styles.statValue} style={{ color: '#6366f1' }}>{stats.applied}</span>
        </div>
        <div className={`${styles.statItem} glass`}>
